        ...
        <nav class="flex items-center justify-between flex-wrap bg-red-700 p-6">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
              <div class="text-sm lg:flex-grow">
                ...
                <a href="{{ url('/home') }}" class="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-white mr-4">
                    HOME
                  </a>
                <a href="{{ route('login') }}" class="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-white mr-4">
                  LOGIN
                </a>
                @if (Route::has('register'))
                <a href="{{ route('register') }}" class="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-white mr-4">REGISTER</a>
                @endif
              </div>
            </div>
            @endif
